...
<head>
  ...
  <link rel="stylesheet" href="styles/abr_style.css">
</head>
<body>
...
<button class="bottom-btn bb-active"  onclick="window.location.href='burial_records.php'; setActive(this)">Burial Records</button>
    ...
    <button class="bottom-btn bb-default" onclick="window.location.href='rental_payment.html'; setActive(this)">Rental &amp;<br>Payment</button>
